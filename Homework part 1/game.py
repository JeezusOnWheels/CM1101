...
def exit_leads_to(exits, direction):#PASS
...
def print_menu_line(direction, leads_to):
    ...
    """
    temp = "Go {} to {}."
    print (temp.format(direction.upper(), leads_to))
...
def print_menu(exits):
    ...
    print("You can:")
    for ex in exits:
        print_menu_line(ex, (exit_leads_to(exits,ex)))#directioin and leads to are needed
    # COMPLETE THIS PART:
...
def is_valid_exit(exits, user_input):#PASS
...
def menu(exits):
    ...
    while True:
        ...
        string = input()
        # Normalise the input
        string = normalise_input(string)
        # Check if the input makes sense (is valid exit)
            # If so, return the player's choice
        if is_valid_exit(exits, string):
            return string
...
def move(exits, direction):
    ...
    False
    """
    #print exit_leads_to(rooms["Reception"]["exits"], "east")
    #print rooms["Tutor"]
...
def main():
    ...
    #print rooms["Tutor"]
    #print rooms[ rooms["Reception"]["exits"]["south"]]#Returns your personal tutor's office#rooms[exits[direction]]
    # Main game loop
    while True:
